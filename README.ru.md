...
**Уже пользуешься установленной версией 0.9.5-3 или новее?** Нажми **Проверить обновления → Доступно обновление** внизу окна приложения. Загрузка и установка начнутся только после твоего нажатия. Portable-версия откроет ссылку для ручного скачивания; при обновлении сохрани папку `Data/`.
