    ...
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="flex-1 flex items-center gap-2">
        ...
        <input
          ...
          style={{
            background: `linear-gradient(to right, var(--color-state-soft) 0%, var(--color-state-soft) ${progressPercent}%, color-mix(in srgb, var(--color-mid-gray) 20%, transparent) ${progressPercent}%, color-mix(in srgb, var(--color-mid-gray) 20%, transparent) 100%)`,
          }}
        />
