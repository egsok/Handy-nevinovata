...
- **В пользовательский словарь можно добавлять фразы из нескольких слов**, например «Visual Studio Code».
...
# klava-nevinovata 0.9.6-1 — English

Based on Handy 0.9.6, with klava-nevinovata's design and custom features preserved: transcription prompts, context across long dictations, and Whisper/Breeze text cleanup.

## Reminder: update from inside the app

**In-app updates are available in installed copies starting with version 0.9.5-3. Click “Check for updates” at the bottom of the window, then “Update available”.** klava-nevinovata downloads and installs the update, then restarts. It may check for updates at startup; downloading and installation begin only after your click. If the button is missing, enable update checks in settings.
...
- **Custom vocabulary accepts multiword phrases**, such as “Visual Studio Code”.
