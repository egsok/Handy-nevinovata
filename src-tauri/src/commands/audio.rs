...
pub async fn update_microphone_mode(app: AppHandle, always_on: bool) -> Result<(), String> {
    update_settings(&app, |s| s.always_on_microphone = always_on);
...
pub async fn set_selected_microphone(app: AppHandle, device_name: String) -> Result<(), String> {
    ...
    update_settings(&app, |s| s.selected_microphone = selected_microphone);
...
pub fn set_selected_output_device(app: AppHandle, device_name: String) -> Result<(), String> {
    ...
    update_settings(&app, |s| s.selected_output_device = selected_output_device);
    Ok(())
}
...
pub fn set_clamshell_microphone(app: AppHandle, device_name: String) -> Result<(), String> {
    ...
    update_settings(&app, |s| s.clamshell_microphone = clamshell_microphone);
    Ok(())
}
...
pub async fn set_selected_channel(app: AppHandle, channel: Option<u16>) -> Result<(), String> {
    ...
    update_settings(&app, |settings| settings.selected_channel = channel);
    Ok(())
}
