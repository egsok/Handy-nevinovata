...
pub fn change_tray_icon(app: &AppHandle, icon: TrayIconState) {
    ...
    // Our main-thread-blockage detector: total icon+menu time. A slow
    // change_tray_icon means the main thread — and with it the whole hotkey
    // pipeline — was blocked for that long.
