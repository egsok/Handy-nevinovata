# Contributing to klava-nevinovata

Thank you for your interest in contributing to klava-nevinovata! This guide will help you get started with contributing to this open source speech-to-text application.

## ⚠️ Feature Freeze

**klava-nevinovata is currently undergoing a feature freeze.** If you are submitting a PR which is a new feature that the community has not asked for, it will be rejected. If the community has asked for it, or you have explicitly gathered support, it may still be considered.
...
klava-nevinovata aims to be the most forkable speech-to-text app. The goal is to create both a useful tool and a foundation for others to build upon—a well-patterned, simple codebase that serves the community. We prioritize:
...
2. **Clone your fork**:
   ...
   ```bash
   git clone git@github.com:YOUR_USERNAME/klava-nevinovata.git
   cd klava-nevinovata
   ```
...
klava-nevinovata follows a clean architecture pattern:
...
1. **Search existing issues** at [github.com/egsok/klava-nevinovata/issues](https://github.com/egsok/klava-nevinovata/issues)
2. **Check discussions** at [github.com/egsok/klava-nevinovata/discussions](https://github.com/egsok/klava-nevinovata/discussions)
...
1. **Search existing discussions** at [github.com/egsok/klava-nevinovata/discussions](https://github.com/egsok/klava-nevinovata/discussions)
2. **Check common feature requests**:
   - [Post-processing / Editing Transcripts](https://github.com/egsok/klava-nevinovata/discussions/168)
   - [Keyboard Shortcuts / Hotkeys](https://github.com/egsok/klava-nevinovata/discussions/211)

### Submitting a Feature Request

1. Go to [Discussions](https://github.com/egsok/klava-nevinovata/discussions)
...
4. Describe your feature idea including:
   ...
   - How it fits with klava-nevinovata's philosophy
...
1. **Search existing issues and PRs** - Check both open AND closed issues and pull requests. Someone may have already addressed this, or there may be a reason it was closed.
   - [Open issues](https://github.com/egsok/klava-nevinovata/issues)
   - [Closed issues](https://github.com/egsok/klava-nevinovata/issues?q=is%3Aissue+is%3Aclosed)
   - [Open PRs](https://github.com/egsok/klava-nevinovata/pulls)
   - [Closed PRs](https://github.com/egsok/klava-nevinovata/pulls?q=is%3Apr+is%3Aclosed)
...
2. **If something was previously closed** - If you want to revisit a closed issue or PR, you need to:
   ...
   - Gather community feedback first via [Discussions](https://github.com/egsok/klava-nevinovata/discussions)
   - Link to that discussion in your PR

3. **Get community feedback for features** - PRs with demonstrated community interest are **much more likely to be merged**. Start a discussion, get feedback, and link to it in your PR. This helps ensure klava-nevinovata stays focused and useful for the most people without becoming bloated.

Community feedback is essential to keeping klava-nevinovata the best it can be for everyone. It helps prioritize what matters most and prevents feature creep.
...
7. **Create a Pull Request**:
   - Go to the [klava-nevinovata repository](https://github.com/egsok/klava-nevinovata)
   ...
   **Remember:** PRs with community support are prioritized. If you haven't already, start a [discussion](https://github.com/egsok/klava-nevinovata/discussions) to gather feedback before or alongside your PR. It is not explicitly required to gather feedback, but it certainly helps your PR get merged faster.
...
- **Discussions**: Ask questions in [GitHub Discussions](https://github.com/egsok/klava-nevinovata/discussions)
## 📜 License

By contributing to klava-nevinovata, you agree that your contributions will be licensed under the MIT License. See [LICENSE](LICENSE) for details.

---

**Thank you for contributing to klava-nevinovata!** Your efforts help make speech-to-text technology more accessible, private, and extensible for everyone.
